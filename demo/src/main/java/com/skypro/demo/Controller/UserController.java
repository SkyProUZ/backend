...
import com.skypro.demo.Service.AttachmentsService;
import com.skypro.demo.Service.UserService;
import com.skypro.demo.Utility.ResultObject;
...
public class UserController {
    ...
    public ResponseEntity<?> getprofile(@RequestBody String user, HttpSession session) throws JSONException {
    ...
    public ResponseEntity<?> getprofileImage(@RequestBody User user, HttpSession session) throws JSONException {
        JSONObject jsonObject = new JSONObject(String.valueOf(user));
