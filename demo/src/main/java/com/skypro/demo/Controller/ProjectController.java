...
import com.skypro.demo.Service.BidService;
import com.skypro.demo.Service.ObjectService;
import com.skypro.demo.Service.ProjectService;
...
public class ProjectController {
    ...
    public ResponseEntity<?> getProjectById(@RequestBody String project, HttpSession session) throws JSONException {
    ...
    public ResponseEntity<?> hireFreelancer(@RequestBody String hireDetails, HttpSession session) throws JSONException {
